...
public class PlayerHealth : MonoBehaviour
{
    ...
    public void TakeDamage(float damage)
    {
        ...
        // Asegúrate de que UIManager esté correctamente inicializado antes de actualizar la UI
        if (UIManager.Instance != null)
        {
            UIManager.Instance.UpdateHealthText();  // Actualiza la UI con la nueva salud
        }
    ...
    public void UseHealObject()
    {
        if (_healObjectQuantity > 0 && !isDead)
        {
            ...
            // Actualizamos la UI con la nueva salud
            if (UIManager.Instance != null)
            {
    ...
    // Método para cargar los datos del progreso solo cuando muere el jugador
    ...
    public void ResetLevel()
    {
        ...
        // Cargar los datos del jugador después de que la escena se haya reiniciado
